        ...
        <div className="row">
          <div className="col-lg-3 col-sm-6 has-anim fade">
            <div className="service-item text-light">
              ...
              <p>
              We are always ready to help any startups reach their first milestone.
              </p>
              <span
          ...
          <div className="col-lg-3 col-sm-6 has-anim fade anim-delay-1">
            <div className="service-item text-light">
              ...
              <h4 className="font-weight-light text-white mb-3">Advisory</h4>
              <p>
              Provide consulting services for top global brands and IP holders.
              </p>
              <span
                className="my-2 d-inline-block"
                style={{ letterSpacing: "-3px" }}
          ...
          <div className="col-lg-3 col-sm-6 has-anim fade anim-delay-2">
            <div className="service-item text-light">
              ...
              <p>
              Invest in projects that have disruptive technology &amp; innovation.
              </p>
              <span
                className="my-2 d-inline-block"
                style={{ letterSpacing: "-3px" }}
          ...
          <div className="col-lg-3 col-sm-6 has-anim fade anim-delay-3">
            <div className="service-item text-light">
              ...
              <p>
              Any individuals that have ideas for a better future deserve support.
              </p>
              <span
                className="my-2 d-inline-block"
                style={{ letterSpacing: "-3px" }}
          ...
          <div className="col-12">
            <a href="/services" className="line-link">
              All Services{" "}
              <svg
