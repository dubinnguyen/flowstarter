        ...
        <div className="container">
          <div className="row justify-content-start justify-content-lg-around align-items-center">
            ...
            <div className="col-xl-5 col-lg-6 mt-5 mt-lg-0">
              ...
              Flowstarter is a digital economy accelerator based in Vietnam👋. 
              We support the most exciting projects in the Metaverse; at the intersection of art, culture, finance, and technology.
              </p>

              <p className="has-anim fade anim-delay-1">
              We believe in the future where all people have access to thriving digital communities and economies without discrimination. As the leading incubator on Flow blockchain, we work closely with the most prominent projects to establish the Metaverse, where companies at the intersection of art, culture, finance, and technology could deliver their best applications.
      ...
      <section className="section bg-white">
        <div className="container">
          ...
          <div className="row row-team">
            ...
            <div class="col-12 mt-5 pt-4 text-center has-anim fade">
            <a class="btn btn-black" href="/team#open-positions" data-text="See Open Positions"><span>See Open Positions</span></a>
            </div>
          </div>
        </div>
      </section>
